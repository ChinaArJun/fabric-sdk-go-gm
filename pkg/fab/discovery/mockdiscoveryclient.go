...
import (
	...
	gprotoext "github.com/ChinaArJun/fabric-sdk-go-gm/internal/github.com/hyperledger/fabric/gossip/protoext"
	"github.com/ChinaArJun/fabric-sdk-go-gm/pkg/common/providers/fab"
	"github.com/ChinaArJun/fabric-sdk-go-gm/pkg/fab/discovery/mocks"
...
func (r *fakeResponse) ForChannel(string) discclient.ChannelResponse {
	...
	//see origins of https://github.com/ChinaArJun/fabric-sdk-go-gm/pull/62
	if r.accessDenied {
