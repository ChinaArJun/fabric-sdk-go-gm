module github.com/ChinaArJun/fabric-sdk-go-gm

go 1.14

require (
	contrib.go.opencensus.io/resource v0.1.1 // indirect
	github.com/ChinaArJun/fabric-sdk-go-gm/cfssl v1.0.1
...
replace (
	github.com/ChinaArJun/fabric-sdk-go-gm/cfssl v1.0.1 => ./cfssl
